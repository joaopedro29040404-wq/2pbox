...
function PaymentResultPageContent() {
  ...
  return (
    <main className="payment-result-page">
      ...
      <style jsx>{`
        .payment-result-page{min-height:100vh;background:#fafafa;color:#111;display:grid;grid-template-rows:auto auto 1fr auto;font-family:Arial,sans-serif;overflow-x:hidden}.payment-result-topbar{background:#111;color:#fff;text-align:center;padding:12px;font-size:11px;font-weight:900;letter-spacing:.18em}.payment-result-topbar span{color:#ffc400;margin:0 8px}.payment-result-header{background:#fff;border-bottom:1px solid #e6e6e6;padding:18px clamp(18px,6vw,72px);overflow:hidden}.payment-brand{display:inline-flex;align-items:center;gap:11px;color:#111;text-decoration:none;min-width:0;max-width:100%}.payment-brand img{width:76px;height:50px;max-width:76px;max-height:50px;flex:0 0 76px;object-fit:contain;object-position:center;display:block}.payment-brand div{display:grid;gap:3px;min-width:0}.payment-brand strong{font-size:20px;letter-spacing:.08em;white-space:nowrap}.payment-brand small{font-size:8px;color:#888;letter-spacing:.14em;font-weight:800;white-space:nowrap}.payment-result-card{width:min(680px,calc(100% - 32px));align-self:center;justify-self:center;margin:42px auto;padding:44px 28px;text-align:center;background:#fff;border:1px solid #e4e4e4;border-radius:20px;box-shadow:0 15px 50px rgba(0,0,0,.06);box-sizing:border-box;overflow:hidden}.result-icon{width:78px;height:78px;margin:0 auto 22px;border-radius:50%;display:grid;place-items:center;background:#fff4bf}.approved .result-icon{color:#198754}.rejected .result-icon,.cancelled .result-icon{color:#c62828;background:#fff0f0}.payment-result-card h1{font-size:clamp(30px,5vw,48px);line-height:1.05;margin:0 0 15px;letter-spacing:-.04em}.payment-result-card>p:not(.result-eyebrow){max-width:520px;margin:0 auto;color:#666;font-size:15px;line-height:1.6}.checking{display:flex;justify-content:center;align-items:center;gap:8px;margin-top:20px;color:#777;font-size:12px}.checking svg{animation:spin 1s linear infinite}.detail{display:block;margin-top:12px;color:#999;font-size:10px}.updated{display:block;margin-top:7px;color:#aaa;font-size:9px}.result-actions{display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-top:28px}.result-actions :global(a){display:inline-flex;align-items:center;justify-content:center;gap:8px;text-decoration:none}.result-actions :global(.primary){background:#ffc400;color:#111;padding:14px 20px;border-radius:9px;font-weight:900}.result-actions :global(.secondary){border:1px solid #111;color:#111;padding:13px 20px;border-radius:9px;font-weight:800}.result-actions :global(.secondary-primary){background:#111;color:#fff;border-color:#111}footer{padding:22px;text-align:center;background:#111;color:#fff;font-size:9px;font-weight:900;letter-spacing:.18em}@keyframes spin{to{transform:rotate(360deg)}}@media(max-width:600px){.payment-result-header{padding:14px 18px}.payment-brand{gap:9px}.payment-brand img{width:62px;height:42px;max-width:62px;max-height:42px;flex-basis:62px}.payment-brand strong{font-size:16px}.payment-brand small{font-size:6.5px}.payment-result-card{margin:25px auto;padding:34px 18px}.result-actions{display:grid}.result-actions :global(a){width:100%}}
      `}</style>
    </main>
  );
}
