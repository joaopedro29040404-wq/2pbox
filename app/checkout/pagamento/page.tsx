...
function PaymentPage() {
  ...
  return (
    <main className="payment-page">
      ...
      <header className="payment-header"><Link href="/" className="payment-brand"><img src="/logo.pnh.png" alt="2P Box"/><div><strong>PAGAMENTO</strong><small>PAGAMENTO SEGURO PELO MERCADO PAGO</small></div></Link></header>
        ...
        <div className="payment-card">
          {paid ? (
            ...
            <>
              ...
              <PaymentBrick amount={amount} orderId={orderId} email={email} preferenceId={preferenceId} onResult={(result) => { if (result.status === 'approved') setPaid(true); else setError(`Pagamento ${result.status || 'em análise'}. Você poderá acompanhar o pedido.`); }} onError={setError}/>
