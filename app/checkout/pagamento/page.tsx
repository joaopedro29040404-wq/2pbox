...
function PaymentPage() {
  ...
  const handlePaymentResult = (result: { id?: string | number; status?: string; statusDetail?: string }) => {
    // O Brick limpa os campos depois que o onSubmit termina. Isso é esperado.
    // O resultado do pagamento deve sempre levar o cliente para a tela de
    // acompanhamento, inclusive quando o pagamento já foi aprovado.
    ...
    <main className="payment-page">
      ...
      <section className="payment-container">
        ...
        <div className="payment-card">
          ...
          <PaymentBrick amount={amount} orderId={orderId} email={email} preferenceId={preferenceId} onResult={handlePaymentResult} onError={setError}/>
