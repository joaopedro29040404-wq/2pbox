...
const fallbackCategories: Category[] = [
  ...
  { name: 'Acessórios para celular', description: 'Acessórios para seu celular no dia a dia.' },
  ...
  return (
    <main className="two-p-home">
      ...
      <section className="two-p-hero">
        ...
        <div className="two-p-container two-p-hero-grid">
          <div className="two-p-hero-copy">
            <div className="two-p-hero-businesses" aria-label="Serviços da 2P Box">
              <div className="two-p-service-track" aria-hidden="true">
                <span>PAPELARIA</span><b>•</b><span>ELETRÔNICOS</span><b>•</b><span>ACESSÓRIOS PARA CELULAR</span><b>•</b><span>XEROX</span><b>•</b><span>PAPELARIA</span><b>•</b><span>ELETRÔNICOS</span><b>•</b><span>ACESSÓRIOS PARA CELULAR</span><b>•</b><span>XEROX</span>
              </div>
            </div>
            <h1>Tudo que você precisa,<br /><em>em um só lugar.</em></h1>
            <p className="two-p-hero-lead">Papelaria, eletrônicos, acessórios para celular e Xerox para facilitar o seu dia a dia.</p>
      ...
      <style jsx global>{`
        ...
        .two-p-hero-businesses{position:relative;width:100%;height:42px;margin:0 0 22px;overflow:hidden;display:flex;align-items:center;border:1px solid rgba(255,255,255,.13);border-radius:9px;background:rgba(255,255,255,.035);box-shadow:inset 0 1px rgba(255,255,255,.04)}
        .two-p-hero-businesses:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#ffc400;z-index:2;box-shadow:0 0 14px rgba(255,196,0,.35)}
        .two-p-service-track{display:flex;align-items:center;width:max-content;white-space:nowrap;animation:twoPServiceMarquee 24s linear infinite;padding-left:24px}
        .two-p-service-track span{font-size:10px;font-weight:900;letter-spacing:.15em;color:rgba(255,255,255,.78)}
        .two-p-service-track b{font-size:9px;color:#ffc400;margin:0 17px;font-weight:900}
        .two-p-hero-businesses:hover .two-p-service-track{animation-play-state:paused}
        @keyframes twoPServiceMarquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}
