    ...
    <main className="home-page">
      ...
      {heroMode === 'carousel' && banners.length ? (
        <section className="home-hero home-carousel">
          <Link href={banners[slide]?.link_url || '/loja'} className="home-carousel-media" aria-label="Abrir banner promocional">
            <img src={banners[slide].image_url} alt="Banner promocional 2P Box" />
          </Link>
