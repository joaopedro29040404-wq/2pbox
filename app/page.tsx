...
export default function Home() {
  ...
  return (
    <main className="home-page">
        ...
        <div className="home-container">
          ...
          <div className="home-path-grid">
            <Link href="/loja" className="home-path-card home-path-products">
              <div className="home-path-art home-path-art-products" aria-hidden="true"><img src="/images/home/produtos-card.svg" alt="" /></div>
            ...
            {printEnabled ? <Link href="/impressao" className="home-path-card print">
              <div className="home-path-art home-path-art-print" aria-hidden="true"><img src="/images/home/impressao-card.svg" alt="" /></div>
      ...
      `}
        /* Referência visual 2P Box — acesso rápido + categorias */
        .home-paths{padding:64px 0 58px;background:#fafaf7}
        .home-path-heading{margin-bottom:22px}
        .home-path-heading .home-eyebrow{margin-bottom:9px}
        .home-path-heading h2{font-size:50px;letter-spacing:-.02em}
        .home-path-heading>span{font-size:12px;margin-top:7px}
        .home-path-grid{gap:14px}
        .home-path-card{min-height:222px;padding:20px 21px;border-radius:18px;background:#fff8d8;border-color:#eadb9a;justify-content:flex-end}
        .home-path-card.print{background:#171717;border-color:#171717}
        .home-path-card:after{right:-65px;top:-78px;width:190px;height:190px;background:#fff0a6}
        .home-path-card.print:after{background:#2a2a2a}
        .home-path-art{position:absolute;right:-2px;top:0;width:58%;height:100%;z-index:1;pointer-events:none;display:flex;align-items:center;justify-content:flex-end;overflow:hidden}
        .home-path-art img{width:100%;height:100%;display:block;object-fit:cover;object-position:center;border-radius:0 18px 18px 0}
        .home-path-art-products{mix-blend-mode:normal}
        .home-path-art-print{width:60%}
        .home-path-card .home-path-content{max-width:59%;z-index:3}
        .home-path-card .home-path-action{z-index:3}
        .home-path-card p{font-size:8px;letter-spacing:.18em;margin-bottom:5px}
        .home-path-card h3{font-size:32px;line-height:.88;margin-bottom:7px}
        .home-path-card span{font-size:11px;line-height:1.45;padding-right:10px}
        .home-path-action{margin-top:17px;font-size:8px}
        .home-path-action svg{width:15px;height:15px}
        .home-category-section{padding-top:64px}
        .home-category-grid{gap:12px}
        .home-category-card{min-height:168px;padding:10px 10px 12px;justify-content:flex-end;background:#fff8d8;border-color:#eadb9a;border-radius:17px}
        .home-category-card:before{height:3px}
        .home-category-card:hover{background:#fffdf0}
        .home-category-image{position:relative;z-index:2;width:100%;height:104px;margin:0 0 9px;display:grid;place-items:center;border-radius:14px;background:#fff4b9;overflow:hidden}
        .home-category-image img{width:100%;height:100%;display:block;object-fit:cover}
        .home-category-copy{width:100%;text-align:left;padding:0 3px}
        .home-category-copy h3{font-size:20px;line-height:.9}
        .home-category-number,.home-category-icon,.home-category-arrow{display:none}
        .home-category-hint{margin-top:13px;font-size:9px}
        @media(max-width:900px){
          .home-path-card{min-height:208px}
          .home-path-card .home-path-content{max-width:62%}
          .home-path-art{width:55%}
          .home-path-art-print{width:58%}
          .home-category-grid{grid-template-columns:repeat(2,minmax(0,1fr))}
          .home-category-card{min-height:160px}
        }
        @media(max-width:680px){
          .home-paths{padding:44px 0 46px}
          .home-path-heading h2{font-size:39px}
          .home-path-grid{grid-template-columns:1fr;gap:10px}
          .home-path-card{min-height:190px;padding:15px;border-radius:15px}
          .home-path-card .home-path-content{max-width:63%}
          .home-path-art{width:52%;right:0}
          .home-path-art-print{width:54%}
          .home-path-card h3{font-size:27px}
          .home-path-card span{font-size:9px}
          .home-path-action{font-size:7px;margin-top:12px}
          .home-category-section{padding-top:42px}
          .home-category-grid{display:flex;gap:9px;overflow-x:auto;scroll-snap-type:x mandatory;padding:2px 1px 7px}
          .home-category-card{min-width:145px;flex:0 0 145px;min-height:154px;padding:9px;border-radius:14px;scroll-snap-align:start}
          .home-category-image{height:88px;margin-bottom:8px;border-radius:12px}
          .home-category-copy h3{font-size:17px}
        }
        @media(max-width:390px){
          .home-path-card .home-path-content{max-width:60%}
          .home-path-art{width:50%}
          .home-path-art-print{width:52%}
          .home-category-card{min-width:132px;flex-basis:132px}
          .home-category-image{height:80px}
        }
</style>
    </main>
  );
