...
export default function Home() {
  ...
  'https://images.pexels.com/photos/7657383/pexels-photo-7657383.jpeg?auto=compress&cs=tinysrgb&w=1200',
  'https://images.unsplash.com/photo-1609529669303-752f4e7843af?auto=format&fit=crop&w=1200&q=85',
  'https://images.pexels.com/photos/33061128/pexels-photo-33061128.jpeg?auto=compress&cs=tinysrgb&w=1200',
  'https://images.pexels.com/photos/21391639/pexels-photo-21391639.jpeg?auto=compress&cs=tinysrgb&w=1200',
      ...
      <style jsx global>{`
        ...
        .home-path-card.print{background:#fff;color:#111;border-color:#e3e3df}
        .home-path-card.print:after{background:#f2f2ef}
        .home-path-card:hover{transform:translateY(-3px);box-shadow:0 16px 36px rgba(0,0,0,.07);border-color:#e4c743}
        .home-path-icon{width:52px;height:52px;border-radius:15px;background:#ffc400;color:#111;box-shadow:0 8px 18px rgba(255,196,0,.16)}
        ...
        .home-category-section{padding-top:72px}
        .home-category-grid{gap:14px}
        .home-category-card{min-height:170px;padding:10px 10px 13px;justify-content:flex-end;background:#fff;border-color:#e3e3df;border-radius:18px;box-shadow:0 8px 22px rgba(0,0,0,.045)}
        .home-category-card:hover{background:#fff;border-color:#e4c743;box-shadow:0 16px 32px rgba(0,0,0,.075)}
        .home-category-image{position:relative;width:100%;height:112px;margin:0 0 11px;display:block;overflow:hidden;border-radius:13px;background:#f2f2ef}
        .home-category-image:after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,0) 52%,rgba(0,0,0,.13) 100%);pointer-events:none}
        .home-category-image img{width:100%;height:100%;display:block;object-fit:cover;object-position:center}
        .home-category-copy{width:100%;padding:0 3px;text-align:left}
        .home-category-copy h3{font-size:21px;line-height:.92;letter-spacing:-.01em}
        .home-category-number,.home-category-icon,.home-category-arrow{display:none}
        .home-category-hint{margin-top:14px;font-size:9px;text-align:right}
        @media(max-width:900px){
          .home-path-card{min-height:180px;padding:20px}
          .home-path-card h3{font-size:29px}
          .home-category-grid{grid-template-columns:repeat(2,minmax(0,1fr))}
          .home-category-card{min-height:165px}
        }
        @media(max-width:680px){
          .home-paths{padding:46px 0 48px}
          .home-path-heading h2{font-size:38px}
          .home-path-grid{grid-template-columns:1fr 1fr;gap:10px}
          .home-path-card{min-height:172px;padding:15px 14px;border-radius:14px}
          .home-path-icon{width:40px;height:40px;border-radius:11px}
          .home-path-card p{font-size:7px;margin:0 0 4px}
          .home-path-card h3{font-size:24px;margin:0 0 5px}
          .home-path-card span{font-size:9px;line-height:1.35;padding-right:0}
          .home-path-action{font-size:7px;gap:4px;margin-top:12px}
          .home-path-action svg{width:14px;height:14px}
          .home-category-section{padding:42px 0 44px}
          .home-category-grid{display:flex;gap:9px;overflow-x:auto;scroll-snap-type:x mandatory;padding:2px 1px 7px;scrollbar-width:none}
