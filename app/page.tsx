        ...
        <div className="home-container">
          ...
          <div className="home-path-grid">
            <Link href="/loja" className="home-path-card home-path-products">
              <div className="home-path-art home-path-art-products" aria-hidden="true"><ShoppingBag /></div>
            ...
            {printEnabled ? <Link href="/impressao" className="home-path-card print">
              <div className="home-path-art home-path-art-print" aria-hidden="true"><Printer /></div>
