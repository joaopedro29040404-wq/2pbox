    ...
    <main className="home-page">
      ...
      <section className="home-paths">
        <div className="home-container">
          <div className="home-path-heading"><p className="home-eyebrow">ESCOLHA O QUE VOCÊ PRECISA</p><h2>COMPRE OU IMPRIMA.</h2><span>Tudo em um só lugar.</span></div>
          <div className="home-path-grid">
            <Link href="/loja" className="home-path-card"><div className="home-path-icon"><ShoppingBag /></div><div className="home-path-content"><p>01 · LOJA</p><h3>PRODUTOS</h3><span>Papelaria, eletrônicos, acessórios e variedades.</span></div><div className="home-path-action">VER PRODUTOS <ArrowRight /></div></Link>
            {printEnabled ? <Link href="/impressao" className="home-path-card print"><div className="home-path-icon"><Printer /></div><div className="home-path-content"><p>02 · SERVIÇO</p><h3>IMPRESSÃO</h3><span>Envie seu arquivo e faça seu pedido.</span></div><div className="home-path-action">IMPRIMIR AGORA <ArrowRight /></div></Link> : null}
          </div>
        </div>
      </section>
