        ...
        <div className="home-container">
          ...
          <div className="home-path-grid">
            <Link href="/loja" className="home-path-card home-path-products">
              <div className="home-path-art home-path-art-products" aria-hidden="true">
                <div className="home-path-bag"><ShoppingBag /></div>
                <div className="home-path-box home-path-box-main"><span>2P</span><b>BOX</b></div>
                <div className="home-path-box home-path-box-small" />
              </div>
              <div className="home-path-content"><p>01 · LOJA</p><h3>PRODUTOS</h3><span>Eletrônicos, acessórios, papelaria e muito mais.</span></div>
            ...
            {printEnabled ? <Link href="/impressao" className="home-path-card print">
              <div className="home-path-art home-path-art-print" aria-hidden="true">
                <div className="home-path-printer"><Printer /></div>
                <div className="home-path-paper home-path-paper-one" />
                <div className="home-path-paper home-path-paper-two" />
              </div>
              <div className="home-path-content"><p>02 · SERVIÇO</p><h3>CENTRAL DE IMPRESSÃO</h3><span>Imprima seus arquivos de forma rápida, fácil e com qualidade.</span></div>
          ...
          <div className="home-category-grid">
            {visibleCategories.map((category, index) => (
              <Link key={category.id || category.name} href={`/loja?categoria=${encodeURIComponent(category.id)}`} className={`home-category-card category-${index + 1}`}>
                <div className="home-category-image" aria-hidden="true"><CategoryIcon index={index} /></div>
