...
export default function Home() {
  ...
  'https://images.unsplash.com/photo-1666771410140-0573b232426e?auto=format&fit=crop&w=1200&q=85',
      ...
      <style jsx global>{`
        ...
        /* Professional category cards — clean product-vitrine direction. */
        ...
        .home-category-card{min-height:235px;padding:12px 12px 14px;display:flex;flex-direction:column;justify-content:flex-end;position:relative;overflow:hidden;text-decoration:none;color:#111;background:#fff;border:1px solid #e2e2de;border-radius:20px;box-shadow:0 8px 24px rgba(0,0,0,.045);transition:transform .22s ease,box-shadow .22s ease,border-color .22s ease}
        ...
        .home-category-image img{width:100%;height:100%;display:block;object-fit:contain;object-position:center;padding:4px}
        ...
        .home-category-hint{margin-top:15px;font-size:9px;text-align:right;color:#888}
        @media(max-width:900px){
          ...
          .home-category-card{min-height:220px}
          .home-category-image{height:142px}
        }
        @media(max-width:680px){
          ...
          .home-category-cta svg{width:12px;height:12px}
