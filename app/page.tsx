  ...
  return (
    <main className="two-p-home">
      ...
      <section className="two-p-hero">
        ...
        <div className="two-p-container two-p-hero-grid">
          <div className="two-p-hero-copy">
            <p className="two-p-eyebrow">2P BOX • PAPELARIA • ELETRÔNICOS • IMPRESSÃO</p>
            <h1>Tudo que você precisa,<br /><em>em um só lugar.</em></h1>
            <p className="two-p-hero-lead">Variedade, qualidade e atendimento próximo para facilitar o seu dia a dia.</p>
      ...
      <style jsx global>{`
        ...
        .two-p-eyebrow{margin:0 0 15px;color:#ffc400;font-size:10px;font-weight:900;letter-spacing:.28em;text-transform:uppercase}
