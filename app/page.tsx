  ...
  return (
    <main className="two-p-home">
        ...
        <div className="two-p-container two-p-hero-grid">
          <div className="two-p-hero-copy">
            <div className="two-p-hero-businesses" aria-label="Serviços da 2P Box">
              <span>PAPELARIA</span><i>•</i><span>ELETRÔNICOS</span><i>•</i><span>ACESSÓRIOS PARA CELULAR</span><i>•</i><span>XEROX</span>
            </div>
      ...
      <style jsx global>{`
        ...
        .two-p-hero-businesses span{display:inline-flex;align-items:center;min-height:32px;padding:7px 11px;border:1px solid rgba(255,196,0,.35);border-radius:999px;background:rgba(255,196,0,.08);color:#fff;white-space:nowrap}
        .two-p-hero-businesses i{font-style:normal;color:#ffc400;font-size:12px}
