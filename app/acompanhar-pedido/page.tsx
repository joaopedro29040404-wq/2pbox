  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      if (!response.ok || !data.order?.id) {
        setError(data.error || 'Nenhum pedido encontrado para este e-mail.');
        return;
      }
      try {
      ...
      setError('Não foi possível consultar o pedido agora. Tente novamente.');
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="track-container">
          ...
          <div className="track-layout">
            <aside className="track-side">
              ...
              <p>Sem login. Use o mesmo e-mail informado no checkout e localize sua compra.</p>
            </aside>
            ...
            <div className="track-card">
              ...
              <form onSubmit={submit} noValidate>
                ...
                <button type="submit" disabled={loading}>{loading ? 'CONSULTANDO...' : 'ACOMPANHAR PEDIDO'} <ArrowRight size={17}/></button>
              </form>
