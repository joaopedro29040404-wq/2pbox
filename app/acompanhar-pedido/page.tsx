  ...
  return (
    <main className="track-page">
      ...
      <style jsx global>{`
        ...
        .track-header{height:86px;background:rgba(255,255,255,.97);backdrop-filter:blur(12px);border-bottom:1px solid var(--line);position:sticky;top:0;z-index:50}.track-header-inner{height:100%;display:flex;align-items:center;gap:38px}.track-brand{display:block;width:112px;height:56px;flex:none}.track-brand img{width:100%;height:100%;object-fit:contain;max-width:100%}.track-nav{display:flex;align-items:center;gap:34px;margin-left:auto}.track-nav a,.track-account{font-size:11px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;text-decoration:none;color:#111}.track-nav a:hover,.track-account:hover{color:var(--gold)}.track-actions{display:flex;align-items:center;gap:20px}.track-account{white-space:nowrap}.track-cart{height:42px;display:flex;align-items:center;gap:9px;padding:0 14px;background:#111;color:#fff;text-decoration:none;border-radius:8px;font-size:11px;font-weight:800}.track-menu{display:none;width:42px;height:42px;background:#fff;border:1px solid #ddd;border-radius:8px}
