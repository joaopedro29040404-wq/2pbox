...
export default function AnalyticsLayout({ children }: { children: ReactNode }) {
  ...
  return <>
    <nav className="analytics-nav"><Link className={pathname === '/admin/analytics' ? 'active' : ''} href="/admin/analytics"><BarChart3 size={15}/> Visão geral</Link><Link className={pathname === '/admin/analytics/produtos' ? 'active' : ''} href="/admin/analytics/produtos"><Package size={15}/> Produtos</Link><Link href="/admin"><ArrowLeft size={14}/> Painel</Link></nav>
    {children}
